...
Its parent has not yet collected its exit status.
...
The child terminates using exit(0).
The parent does not call wait() to collect the child's exit status.
The parent sleeps for 30 seconds.
During this time, the terminated child remains in the process table as a zombie process.
